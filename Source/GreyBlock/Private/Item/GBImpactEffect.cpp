...
// Sets default values
AGBImpactEffect::AGBImpactEffect()
{
...
void AGBImpactEffect::PostInitializeComponents()
{
...
UParticleSystem* AGBImpactEffect::GetImpactFX(EPhysicalSurface SurfaceType) const
{
	switch (SurfaceType)
	{
...
USoundCue* AGBImpactEffect::GetImpactSound(EPhysicalSurface SurfaceType) const
{
	switch (SurfaceType)
	{
	case SURFACE_DEFAULT:
