...
#include "GBPlayerCameraManager.generated.h"

/**
 * 
 */
UCLASS()
class GREYBLOCK_API AGBPlayerCameraManager : public APlayerCameraManager
{
	GENERATED_BODY()
	
	AGBPlayerCameraManager(const FObjectInitializer& ObjectInitializer);
