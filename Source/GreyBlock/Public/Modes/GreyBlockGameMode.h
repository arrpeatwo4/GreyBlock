...
#include "GreyBlockGameMode.generated.h"

/**
 * 
 */
UCLASS()
class GREYBLOCK_API AGreyBlockGameMode : public AGameMode
{
	GENERATED_BODY()
	
protected:

	AGreyBlockGameMode(const FObjectInitializer& ObjectInitializer);
...
protected:
	...
	TArray<TSubclassOf<class AGBMutator>> MutatorClasses;

	/* First mutator in the execution chain */
	AGBMutator* BaseMutator;

    void AddMutator(TSubclassOf<AGBMutator> MutClass);
